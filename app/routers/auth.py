...
logger = logging.getLogger("vibe-garage-auth")
...
def reset_password(data: ResetPasswordRequest, x_2fa_code: Optional[str] = Header(None, alias="X-2FA-Code"), db: Session = Depends(get_db)):
