...
Revision ID: 8ccba097521f
Revises: bbfea6c3ec6f
Create Date: 2025-12-23 10:42:22.061496
...
revision: str = '8ccba097521f'
down_revision: Union[str, Sequence[str], None] = 'bbfea6c3ec6f'
...
def downgrade() -> None:
    ...
    sa.Column('reset_token', sa.VARCHAR(), nullable=True),
